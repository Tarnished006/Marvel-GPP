...
class SignalBus(QObject):
    ...
    air_mouse_toggle = pyqtSignal(bool)              # turns air-mouse control on/off
    air_mouse_gesture_set = pyqtSignal(bool)         # 👍 True = ON  |  👎 False = OFF
    voice_command = pyqtSignal(str)                 # Recognized voice command
